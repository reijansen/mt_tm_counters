  ...
  return (
    <div className="grid gap-5">
      <section className="surface-panel p-5 sm:p-6">
        ...
        <h2 className="app-heading mt-3">Simulator Controls</h2>
        <p className="mt-3 text-sm leading-7 text-zinc-400 sm:text-base">
          Choose an operation, set the register values, and observe how the machine
          evolves through the recorded steps of the computation.
        </p>
        {isSubmitting ? (
      ...
      <section className="surface-panel p-5 sm:p-6" ref={resultRef}>
        <div className="flex flex-wrap items-start justify-between gap-4">
          <div className="max-w-2xl">
            ...
            <h2 className="app-heading mt-3">Simulation Output</h2>
            <p className="mt-3 text-sm leading-7 text-zinc-400 sm:text-base">
              Review the machine outcome first, then move through the recorded steps to
              inspect how the tapes and registers changed during execution.
            </p>
          </div>
          {result ? (
        ...
        <div className="section-rule mt-6">
          <div className="flex flex-wrap items-center justify-between gap-3">
            <div>
              ...
              <h2 className="app-heading mt-3">Step Playback</h2>
            </div>
            {result?.steps?.length ? (
          ...
          <p className="mt-3 max-w-3xl text-sm leading-7 text-zinc-400 sm:text-base">
            Use the playback controls to follow the transition history one step at a
            time. The current step view highlights the active tapes and head positions.
          </p>
          <div className="mt-5">
            <TracePlayer
        ...
        <details className="group">
          <summary className="flex cursor-pointer list-none flex-wrap items-center justify-between gap-3">
            <div>
              ...
              <h2 className="app-heading mt-3">Detailed Execution Trace</h2>
            </div>
          ...
          <p className="mt-3 text-sm leading-7 text-zinc-400 sm:text-base">
            Use the detailed list below when you want to inspect each transition or jump
            directly to a specific step.
          </p>
          <div className="mt-5">
            <ExecutionTrace
              currentStepIndex={focusedStepIndex}
